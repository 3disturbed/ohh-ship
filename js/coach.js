...
(function (S) {
  ...
  var STEPS = [
    ...
    { id: 'clear', short: 'motor out along the buoyed channel',
      patience: 120, toast: ['Sea room', 'Follow the buoyed channel out — heading seaward, keep the red cans to starboard and the green cones to port. Take her well clear before you make sail.'],
